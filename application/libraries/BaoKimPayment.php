...
class BaoKimPayment 
{
	...
	public $baokim_url = 'https://www.baokim.vn/payment/customize_payment/order';

	// Mã merchante site 
	public $merchant_id = '15441';//'100001';	// Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site

	// Mật khẩu bảo mật
	public $secure_pass = '0ea2f214aa3497dd';//'DED01D1CFF3BE2767196FF0080F6DB6D5C'; // Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site
	...
	// Mã merchante site 
	  $merchant_id = '15441';//'100001';	// Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site

	// Mật khẩu bảo mật
	  $secure_pass = '0ea2f214aa3497dd';//'DED01D1CFF3BE2767196FF0080F6DB6D5C'; // Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site
        //
	...
	public function verifyResponseUrl($params)
	{
		...
		//unset($this->input->get('checksum'));
		
		ksort($params);
		$str_combined = $this->secure_pass.implode('', $_REQUEST);
